...
mkdir -p $RPM_BUILD_ROOT%{_datadir}/pixmaps/goose
for i in goose-pixmaps/*; do
  install -p -m 644 $i $RPM_BUILD_ROOT%{_datadir}/pixmaps/goose
done
...
mkdir -p $RPM_BUILD_ROOT%{_datadir}/firstboot/themes/GL
for i in firstboot/* ; do
  install -p -m 644 $i $RPM_BUILD_ROOT%{_datadir}/firstboot/themes/GL
done
...
cp -rp kde-splash/GL6/ $RPM_BUILD_ROOT%{_kde4_appsdir}/ksplash/Themes/
pushd $RPM_BUILD_ROOT%{_kde4_appsdir}/ksplash/Themes/GL6/1920x1200/
...
cp -rp kde-kdm/GL6/ $RPM_BUILD_ROOT/%{_kde4_appsdir}/kdm/themes/
pushd $RPM_BUILD_ROOT/%{_kde4_appsdir}/kdm/themes/GL6/
popd
...
%{_kde4_appsdir}/ksplash/Themes/GL6/
%{_kde4_appsdir}/kdm/themes/GL6/
%{_kde4_datadir}/wallpapers/GL6/
